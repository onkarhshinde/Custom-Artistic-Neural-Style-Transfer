...
def match_histograms(source, template):
    ...
    # take the cumsum of the counts and normalize by the number of pixels to get the empirical cumulative distribution functions for the source and template images 
